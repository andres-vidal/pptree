...
namespace ppforest2 {
  ...
  struct Forest : public Model {
     ...
     */
    virtual types::FeatureVector
    vi_permuted(types::FeatureMatrix const& x, types::OutcomeVector const& y, int seed) const = 0;
     ...
     */
    VariableImportance
    variable_importance(types::FeatureMatrix const& x, types::OutcomeVector const& y, int seed) const;
