...
# pptr Visualization
#
# Native ggplot2 rendering for pptr and pprf models.  Provides:
...
#
# Node dimensions (ppforest2_node_w, etc.) must match the C++ LayoutParams
...
ppforest2_lw_medium <- 0.6    # boundary lines, thresholds
...
ppforest2_col_threshold <- "grey25"
