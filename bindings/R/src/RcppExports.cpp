...
std::string ppforest2_save_model_json(Model::Ptr model, std::vector<std::string> groups, bool include_metrics, const FeatureMatrix& x, ResponseVector y, std::vector<std::string> feature_names);
