...
#'
#' Creates a dimensionality reduction strategy that randomly selects a subset
...
#' @return A \code{dr_strategy} object.
#' @seealso \code{\link{pprf}}, \code{\link{dr_noop}}, \code{\link{pp_pda}}, \code{\link{sr_mean_of_means}}
#' @examples
...
#'
#' @export
dr_uniform <- function(n_vars = NULL, p_vars = NULL) {
  ...
  structure(list(name = "uniform", display_name = "Uniform random", n_vars = n_vars, p_vars = p_vars), class = "dr_strategy")
}

#' No-op dimensionality reduction strategy.
#'
#' Creates a dimensionality reduction strategy that uses all variables at each
#' split. This is the default for single trees (\code{\link{pptr}}).
#'
#' @return A \code{dr_strategy} object.
#' @seealso \code{\link{pptr}}, \code{\link{dr_uniform}}, \code{\link{pp_pda}}, \code{\link{sr_mean_of_means}}
#' @examples
#' dr_noop()
#'
#' @export
dr_noop <- function() {
  structure(list(name = "noop", display_name = "All variables"), class = "dr_strategy")
}
