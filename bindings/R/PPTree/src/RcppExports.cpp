...
// pptree_train_glda
Tree<float, int> pptree_train_glda(const Data<float>& data, const DataColumn<int>& groups, const float lambda);
...
Forest<float, int> pptree_train_forest_glda(const Data<float>& data, const DataColumn<int>& groups, const int size, const int n_vars, const float lambda, SEXP n_threads);
