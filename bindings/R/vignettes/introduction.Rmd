...
- `dr_uniform(n_vars)` or `dr_uniform(p_vars)` — random variable selection
- `dr_noop()` — use all variables (default for single trees)
- `sr_mean_of_means()` — midpoint split rule (default)
